  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      try {
        ...
        setLoading(true);
        let url = `http://localhost:8083/Card/${cardId}/Transactions?`;
  ...
  return (
    <div className="p-6 mx-auto bg-white rounded-lg shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-medium text-gray-800">Card Transactions History</h2>
